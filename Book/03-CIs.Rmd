...
<!-- ```{r Table3.2, include=FALSE} -->
<!-- <<Example3.5>> -->
<!-- ``` -->

<!-- ```{r Table3.3, include=FALSE} -->
<!-- <<Example3.5>> -->
<!-- ``` -->
